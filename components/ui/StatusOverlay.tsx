  ...
  return (
    ...
    >
      <div className="w-full max-w-md rounded-xl border border-[var(--border)] bg-white p-6 text-center shadow-xl">
        <p id="echly-status-overlay-title" className="text-lg font-medium text-[var(--text-heading)]">
          {title}
        </p>
        <p className="mt-2 text-sm text-[var(--text-secondary)]">{message}</p>
        <button
          type="button"
          className="mt-5 rounded-lg bg-[var(--brand)] px-4 py-2 text-sm font-medium text-white hover:opacity-90"
