    ...
    return (
      ...
      >
        <button
          ...
          className="flex flex-col items-center gap-1 p-2 rounded-lg text-[var(--text-tertiary)] hover:bg-black/[0.04] hover:text-[var(--text-primary-strong)] transition-colors duration-120 focus:outline-none focus-visible:ring-1 focus-visible:ring-[var(--accent-operational)]"
    ...
    >
      <div className="shrink-0 flex items-center justify-between px-4 py-3 border-b border-[var(--layer-1-border)]">
        ...
        <button
          type="button"
          onClick={handleToggle}
          className="p-1 rounded text-[var(--text-tertiary)] hover:bg-black/[0.04] hover:text-[var(--text-primary-strong)] transition-colors duration-120 focus:outline-none focus-visible:ring-1 focus-visible:ring-[var(--accent-operational)]"
      ...
      <div className="flex-1 min-h-0 overflow-y-auto px-4 py-4 space-y-6">
        ...
        <section>
          <h3 className="text-[12px] font-medium text-[var(--text-primary-strong)] mb-2">
            Related patterns
          </h3>
          <ul className="space-y-1.5 text-[12px] text-[var(--text-secondary-soft)]">
        ...
        {/* Risk signals */}
        <section>
          <h3 className="flex items-center gap-2 text-[12px] font-medium text-[var(--text-primary-strong)] mb-2">
        ...
        <section>
          ...
          {relatedTicketIds.length > 0 ? (
            <ul className="space-y-1 text-[12px] text-[var(--text-secondary-soft)]">
            ...
            <p className="text-[12px] text-[var(--text-tertiary)]">None linked.</p>
          )}
        </section>
        ...
        <section>
          ...
          <p className="text-[12px] text-[var(--text-tertiary)]">Unassigned</p>
        </section>
        ...
        <section>
          ...
          <p className="text-[12px] text-[var(--text-tertiary)]">Low — 1 of 12 open this week.</p>
        </section>
        ...
        <section>
          ...
          <p className="text-[12px] text-[var(--text-tertiary)]">No prior resolutions.</p>
        </section>
      </div>
    </aside>
  );
