  ...
  return (
    <div
      ...
      className="px-6 py-3.5 flex justify-between items-center
                 bg-[rgba(0,0,0,0.02)] border-b border-[rgba(0,0,0,0.06)]
                 cursor-move"
    >
      <div className="flex items-center gap-2">
        <Image src="/Echly_logo.svg" alt="Echly" width={25} height={25} />
      ...
      <div className="flex items-center gap-0 relative" ref={menuRef}>
        ...
        <button
          onClick={onMoreClick}
          className="p-2 rounded-md hover:bg-[rgba(0,0,0,0.04)] transition-colors"
        ...
        {showMenu && (
          <div className="absolute right-0 top-12
                              ...
                              rounded-md shadow-md w-56 py-2">
            <button
