...
<title>Action needed: Payment failed for Echly</title>
</head>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#FFFFFF;border-radius:16px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,0.08);">
      ...
      <tr>
        <td style="padding:36px 36px 28px;">
          <h1 style="margin:0 0 16px;font-size:24px;font-weight:700;color:#111;letter-spacing:-0.3px;">Action needed: Payment failed</h1>
          <p style="margin:0 0 16px;font-size:15px;color:#444;line-height:1.6;">
            We were unable to process your payment for the Echly Business plan on <strong>${workspaceName}</strong>. This may be because your card has expired or has insufficient funds.
          </p>
          ...
          <a href="${portalUrl}" style="display:inline-block;background:#1775E0;color:#FFFFFF;font-size:15px;font-weight:600;text-decoration:none;padding:13px 26px;border-radius:10px;">
