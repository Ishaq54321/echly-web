          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              <p style="margin:0 0 24px;font-size:15px;color:#54495F;">
                Your request to access <strong style="color:#15101F;">${escapeHtml(sessionName)}</strong> has been approved. You can now view and resolve feedback.
              </p>
        ...
        <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;max-width:560px;width:100%;">
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              <p style="margin:0 0 24px;font-size:15px;color:#54495F;">
                Your request to access <strong style="color:#15101F;">${escapeHtml(sessionName)}</strong> was not approved. Reach out to the session owner if you think this was a mistake.
              </p>
              <p style="margin:0;font-size:13px;color:#8A8096;">
                ${escapeHtml(workspaceName)}
              </p>
