    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#FFFFFF;border-radius:16px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,0.08);">
      ...
      <tr>
        <td style="padding:36px 36px 28px;">
          <h1 style="margin:0 0 16px;font-size:24px;font-weight:700;color:#111;letter-spacing:-0.3px;">Confirm your email change</h1>
          ...
          <a href="${confirmUrl}" style="display:inline-block;background:#1775E0;color:#FFFFFF;font-size:16px;font-weight:600;text-decoration:none;padding:14px 28px;border-radius:10px;letter-spacing:0.1px;">
            Confirm new email
          </a>
        </td>
      </tr>
      ...
      <tr>
        <td style="padding:20px 36px 28px;border-top:1px solid #F0F0F0;">
          <p style="margin:0 0 4px;font-size:13px;color:#999;">This link expires in 24 hours.</p>
