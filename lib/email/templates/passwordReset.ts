...
<title>Reset your Echly password</title>
</head>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#FFFFFF;border-radius:16px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,0.08);">
      ...
      <tr>
        <td style="padding:36px 36px 28px;">
          <h1 style="margin:0 0 16px;font-size:24px;font-weight:700;color:#111;letter-spacing:-0.3px;">Reset your password</h1>
          <p style="margin:0 0 12px;font-size:15px;color:#444;line-height:1.6;">
            Hi ${userName}, you requested a password reset for your Echly account. Click below to choose a new password.
          </p>
          <p style="margin:0 0 28px;font-size:14px;color:#777;line-height:1.6;padding:14px 16px;background:#FFF8E1;border-radius:8px;border-left:3px solid #F59E0B;">
            This link expires in 1 hour. If you didn't request a password reset, you can safely ignore this email.
          </p>
          <a href="${resetUrl}" style="display:inline-block;background:#1775E0;color:#FFFFFF;font-size:16px;font-weight:600;text-decoration:none;padding:14px 28px;border-radius:10px;letter-spacing:0.1px;">
            Reset password
          </a>
        </td>
      </tr>
