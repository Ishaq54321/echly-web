...
<title>Verify your email — Annote</title>
</head>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#FFFFFF;border-radius:16px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,0.08);">
      ...
      <tr>
        <td style="padding:36px 36px 28px;">
          <h1 style="margin:0 0 16px;font-size:24px;font-weight:700;color:#15101F;letter-spacing:-0.3px;">Verify your email</h1>
          ...
          <p style="margin:0 0 28px;font-size:14px;color:#8A8096;line-height:1.6;">
            This link expires in 1 hour. If you didn't create an Annote account, you can safely ignore this email.
          </p>
          <a href="${verifyUrl}" style="display:inline-block;background:#5A49BF;color:#FFFFFF;font-size:16px;font-weight:600;text-decoration:none;padding:14px 28px;border-radius:10px;letter-spacing:0.1px;">
            Verify email
          </a>
        </td>
      </tr>
      ...
      <tr>
        <td style="padding:20px 36px 28px;border-top:1px solid #FAFAF7;">
          <p style="margin:0 0 4px;font-size:13px;color:#8A8096;">This link expires in 1 hour.</p>
