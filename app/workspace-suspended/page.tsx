  ...
  return (
    <div className="flex h-full flex-col items-center justify-center bg-[var(--surface-subtle)] px-4">
      <div className="w-full max-w-md rounded-xl border border-[var(--border)] bg-white p-8 text-center shadow-sm">
        <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-[var(--surface-hover)] text-neutral-500">
        ...
        <div className="mt-6">
          <Link
            ...
            className="inline-flex items-center justify-center rounded-lg border border-[var(--border)] bg-white px-4 py-2 text-sm font-medium text-neutral-700 shadow-sm transition hover:bg-[var(--surface-hover)] focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2"
          >
            Contact Support
          </Link>
        </div>
