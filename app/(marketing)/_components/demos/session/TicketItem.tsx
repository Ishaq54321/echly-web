/**
 * TicketItem — marketing forklift of components/layout/operating-system/TicketItem.tsx
 *
 * Modifications from source:
 * - NONE to JSX / className / styles — copied verbatim.
 * - Kept the pure `getTicketIconFromTags` util import (no Firebase/providers in
 *   its dependency tree — only lucide icon maps).
 * - No hooks stripped (the source has none); no handlers changed (onSelect is a
 *   plain prop callback the demo wires to local state).
 */
"use client";
