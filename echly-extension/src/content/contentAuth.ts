/**
 * Auth fetch for content script: proxies requests through background (no Firebase in content).
 * Background adds Bearer token via echly-api / getValidToken().
 */
...
export function createApiClient(): {
  ...
  return { apiFetch, authFetch, clearAuthTokenCache };
}
